...
<template>
    <FrontLayout :title="title">
        ...
        <div class="min-h-screen bg-slate-50">
            ...
            <div class="md:hidden bg-white border-b border-slate-200 sticky top-0 z-30">
                <div class="flex overflow-x-auto" style="-ms-overflow-style:none;scrollbar-width:none;">
                    <Link
                        v-for="item in nav"
                        :key="item.href"
                        :href="item.href"
                        class="flex-none px-4 py-3.5 text-xs font-semibold whitespace-nowrap border-b-2 transition-colors flex items-center gap-1.5"
            ...
            <!-- ─── Layout principal ─────────────────────────────────── -->
            <div class="container mx-auto px-4 py-6 md:py-8 md:flex md:gap-6 max-w-5xl">
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 overflow-hidden sticky top-4">
                        ...
                        <div class="border-t border-slate-100 px-4 py-3">
                            <Link
                                ...
                                method="post"
                                as="button"
                                class="w-full flex items-center gap-3 px-1 py-1 text-sm text-slate-400 hover:text-red-600 transition-colors"
                            >
