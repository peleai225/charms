                ...
                <div class="container mx-auto px-4">
                    <div class="flex items-center gap-3 h-16">
                        ...
                        <div class="flex items-center gap-1 sm:gap-2 ml-auto md:ml-0">
                            ...
                            <div v-else class="relative hidden sm:block" @mouseenter="openAccountDropdown" @mouseleave="closeAccountDropdown">
                ...
                <div class="container mx-auto px-4 py-3">
                    ...
                    <div class="space-y-0.5 mb-3">
                        <Link href="/" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition"
                              :class="$page.url === '/' ? 'bg-slate-50 text-slate-900 font-semibold' : 'text-slate-600 hover:bg-slate-50'">
                            Accueil
                        </Link>
                        <Link href="/boutique" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition"
                              :class="$page.url.startsWith('/boutique') ? 'bg-slate-50 text-slate-900 font-semibold' : 'text-slate-600 hover:bg-slate-50'">
                            Boutique
                        </Link>
                        <Link href="/a-propos" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition"
                              :class="$page.url === '/a-propos' ? 'bg-slate-50 text-slate-900 font-semibold' : 'text-slate-600 hover:bg-slate-50'">
                            À propos
                        </Link>
                        <Link href="/contact" class="flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition"
                              :class="$page.url === '/contact' ? 'bg-slate-50 text-slate-900 font-semibold' : 'text-slate-600 hover:bg-slate-50'">
                            Contact
                        </Link>
                    </div>
                    <!-- Catégories -->
