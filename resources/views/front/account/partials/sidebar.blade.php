    ...
    <div class="flex overflow-x-auto gap-1 pb-1 scrollbar-hide">
        <a href="{{ route('account.dashboard') }}"
           class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium whitespace-nowrap flex-shrink-0 transition-colors
                  {{ request()->routeIs('account.dashboard') ? 'bg-primary-600 text-white' : 'bg-white border border-slate-200 text-slate-600 hover:border-primary-300' }}">
        ...
        <a href="{{ route('account.orders') }}"
           class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium whitespace-nowrap flex-shrink-0 transition-colors
                  {{ request()->routeIs('account.orders*') ? 'bg-primary-600 text-white' : 'bg-white border border-slate-200 text-slate-600 hover:border-primary-300' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('account.addresses') }}"
           class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium whitespace-nowrap flex-shrink-0 transition-colors
                  {{ request()->routeIs('account.addresses*') ? 'bg-primary-600 text-white' : 'bg-white border border-slate-200 text-slate-600 hover:border-primary-300' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('account.wishlist.index') }}"
           class="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium whitespace-nowrap flex-shrink-0 transition-colors
                  {{ request()->routeIs('account.wishlist*') ? 'bg-primary-600 text-white' : 'bg-white border border-slate-200 text-slate-600 hover:border-primary-300' }}">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-primary-600 p-5">
            <div class="flex items-center gap-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-sm text-primary-100 truncate">{{ auth()->user()->email }}</p>
                </div>
            </div>
        </div>
        ...
        <nav class="p-3 space-y-0.5">
            <a href="{{ route('account.dashboard') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors
                      {{ request()->routeIs('account.dashboard') ? 'bg-primary-50 text-primary-600 font-semibold' : 'text-slate-600 hover:bg-slate-50 font-medium' }}">
            ...
            <a href="{{ route('account.orders') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors
                      {{ request()->routeIs('account.orders*') ? 'bg-primary-50 text-primary-600 font-semibold' : 'text-slate-600 hover:bg-slate-50 font-medium' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                </svg>
                Mes commandes
            ...
            <a href="{{ route('account.addresses') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors
                      {{ request()->routeIs('account.addresses*') ? 'bg-primary-50 text-primary-600 font-semibold' : 'text-slate-600 hover:bg-slate-50 font-medium' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
            ...
            <a href="{{ route('account.wishlist.index') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-colors
                      {{ request()->routeIs('account.wishlist*') ? 'bg-primary-50 text-primary-600 font-semibold' : 'text-slate-600 hover:bg-slate-50 font-medium' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                </svg>
