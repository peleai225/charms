...
<div class="min-h-[80vh] flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-primary-900 relative overflow-hidden items-center justify-center p-12">
        <!-- Decorative orbs -->
        ...
        <div class="relative text-white max-w-md">
            ...
            <h2 class="text-3xl font-bold mb-3">Content de vous revoir</h2>
            <p class="text-slate-300 text-base leading-relaxed mb-10">Connectez-vous pour retrouver vos commandes, vos adresses enregistrées et profiter d'offres personnalisées.</p>
            ...
            <div class="space-y-4">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-sm text-slate-300">Suivi de commandes en temps réel</span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
                        <svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm text-slate-300">Offres et réductions exclusives</span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
                        <svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm text-slate-300">Paiement et données 100% sécurisés</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center py-12 px-6 sm:px-12 bg-white">
        <div class="w-full max-w-md">
            ...
            <!-- Messages flash -->
            @if (session('error'))
                <div class="mb-6 p-4 rounded-xl bg-red-50 border border-red-100 text-red-600 text-sm flex items-center gap-2">
            ...
            @if (session('success'))
                <div class="mb-6 p-4 rounded-xl bg-green-50 border border-green-100 text-green-600 text-sm flex items-center gap-2">
                    <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            id="email"
                            value="{{ old('email') }}"
                            class="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all bg-slate-50 focus:bg-white text-sm"
