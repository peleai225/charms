        ...
        <div class="relative z-10">
            <div class="relative h-[180px]">
                ...
                <div x-show="testIndex === {{ $i }}" x-cloak
                     ...
                     class="absolute inset-0 bg-white/[0.08] backdrop-blur-sm border border-white/15 rounded-2xl p-5 flex flex-col justify-center">
                    ...
                    <p class="text-white/85 text-sm italic leading-relaxed line-clamp-3">"{{ $t['text'] }}"</p>
                    <p class="text-white/55 text-xs mt-3 font-medium">— {{ $t['name'] }}, {{ $t['city'] }}</p>
                </div>
                @endforeach
            </div>
            {{-- Indicateurs --}}
