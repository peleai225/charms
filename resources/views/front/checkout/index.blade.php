                ...
                <div class="space-y-3">
                    ...
                    <label class="relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200"
                        ...
                        <div class="flex items-center gap-4 flex-1">
                            ...
                            <div class="w-12 h-12 bg-white rounded-lg flex items-center justify-center border border-gray-100">
                                <img src="https://moneyfusion.net/logo.svg" alt="MoneyFusion" class="w-10 h-10 object-contain">
                            </div>
                            <div>
