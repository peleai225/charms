    ...
    <div class="container mx-auto px-4 py-4">
        ...
        <div class="flex items-center gap-0 max-w-sm">
            <div class="flex items-center gap-1.5">
                <div class="w-6 h-6 rounded-full bg-blue-600 text-white text-xs flex items-center justify-center font-bold flex-shrink-0">1</div>
                <span class="text-sm font-semibold text-blue-600 hidden sm:inline">Livraison</span>
            </div>
        ...
        <div class="lg:col-span-3 space-y-5">
                ...
                <div class="mb-5" x-data="{ showNew: false }">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                        ...
                        <label class="relative border-2 rounded-lg p-4 cursor-pointer transition-colors"
                            :class="selectedAddress === {{ $addr->id }} ? 'border-blue-600 bg-blue-50' : 'border-slate-200 hover:border-slate-300'">
                            ...
                            @if($addr->is_default)
                            <span class="absolute top-2 right-2 text-[10px] bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded font-medium">Par défaut</span>
                            @endif
                        </label>
                        @endforeach
                    </div>
                    ...
                    <div x-show="showNew" x-transition class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" x-model="shipping.first_name"
                                class="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-colors bg-white text-sm">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" x-model="shipping.city" @input.debounce.400ms="calcShipping()"
                                placeholder="Ex: Abidjan" class="w-full px-4 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-colors bg-white text-sm">
                        </div>
                        <div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="shipping_address" id="shipping_address" required
                                ...
                                class="flex-1 px-4 py-2.5 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-colors bg-white text-sm">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
                <h2 class="text-base font-semibold text-slate-900 mb-4 flex items-center gap-2">
                    <svg class="w-5 h-5 text-blue-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    Contact
                </h2>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6" x-data="{ uiMethod: paymentMethod }">
                ...
                <div class="space-y-3">
                    ...
                    <label class="flex items-center p-4 border-2 rounded-xl cursor-pointer transition-colors select-none"
                        :class="uiMethod === 'moneyfusion' ? 'border-blue-600 bg-blue-50' : 'border-slate-200 hover:border-slate-300'"
                        @click="uiMethod = 'moneyfusion'; paymentMethod = 'moneyfusion'">
                        <div class="flex items-center gap-3 flex-1">
                            <div class="w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0"
                                :class="uiMethod === 'moneyfusion' ? 'border-blue-600' : 'border-slate-300'">
                                <div class="w-2.5 h-2.5 rounded-full" :class="uiMethod === 'moneyfusion' ? 'bg-blue-600' : ''"></div>
                            </div>
                    ...
                    <label class="flex items-center p-4 border-2 rounded-xl cursor-pointer transition-colors select-none"
                        :class="uiMethod === 'cod' ? 'border-blue-600 bg-blue-50' : 'border-slate-200 hover:border-slate-300'"
                        @click="uiMethod = 'cod'; paymentMethod = 'cod'">
                        <div class="flex items-center gap-3 flex-1">
                            <div class="w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0"
                                :class="uiMethod === 'cod' ? 'border-blue-600' : 'border-slate-300'">
                                <div class="w-2.5 h-2.5 rounded-full" :class="uiMethod === 'cod' ? 'bg-blue-600' : ''"></div>
                            </div>
            ...
            <details class="group bg-white rounded-xl border border-slate-200">
                ...
                <div class="px-6 pb-5">
                    <textarea name="notes" rows="3" placeholder="Instructions spéciales, point de repère..."
                        class="w-full px-4 py-2.5 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-colors resize-none bg-white">{{ old('notes') }}</textarea>
                </div>
            </details>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl border border-slate-200 p-5 sticky top-24">
                ...
                <button type="submit" :disabled="isSubmitting"
                    class="mt-5 w-full py-4 px-6 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 text-sm">
