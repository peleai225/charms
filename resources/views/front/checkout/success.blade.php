...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto text-center">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-left mt-6">
            ...
            <div class="space-y-3 mb-4">
                ...
                <div class="flex justify-between items-center py-2 border-b border-gray-100 last:border-0">
                    ...
                    <p class="font-medium">{{ number_format($item->total, 0, ',', ' ') }} F</p>
                </div>
                @endforeach
            </div>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <a href="{{ route('shop.index') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @auth
            <a href="{{ route('account.orders') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-xl transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
