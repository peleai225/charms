...
<section class="bg-slate-900 min-h-[60vh] md:min-h-[70vh] flex items-center">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-20 text-center w-full">
        <p class="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-4">{{ $siteName }}</p>
        ...
        <div class="flex flex-wrap items-center justify-center gap-3">
            <a href="{{ route('shop.index') }}"
               class="inline-flex items-center gap-2 px-7 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors text-sm">
...
<section class="bg-white border-y border-slate-100">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 divide-x divide-slate-100">
            ...
            <div class="flex items-center gap-3 px-5 py-5">
                <div class="w-9 h-9 rounded-lg bg-blue-50 flex items-center justify-center shrink-0">
                    <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                </div>
                <div>
...
<section class="py-12 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-end justify-between mb-8">
            ...
            <a href="{{ route('shop.index') }}" class="inline-flex items-center gap-1 text-sm font-semibold text-blue-600 hover:text-blue-700 transition-colors">
